...
class ForgotPasswordPage extends StatefulWidget {
  ...
  @override
  State<ForgotPasswordPage> createState() => _ForgotPasswordPageOldPageState();
}

class _ForgotPasswordPageOldPageState extends State<ForgotPasswordPage> {
  String _email = '';
  bool visible = false;
  final _formKey = GlobalKey<FormState>();
  TextEditingController emailcontroller = TextEditingController();
        ...
        showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: Text(
                  'Please enter your username/password before you click submit.'),
              actions: [
                TextButton(
                  child: Text('Ok'),
                  onPressed: () {
